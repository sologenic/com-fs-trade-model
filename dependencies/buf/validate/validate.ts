...
//   protoc               v7.35.1
// source: dependencies/buf/validate/validate.proto
...
export const PredefinedRules = {
  ...
  fromJSON(object: any): PredefinedRules {
    return { cel: globalThis.Array.isArray(object?.cel) ? object.cel.map((e: any) => Rule.fromJSON(e)) : [] };
  },
...
export const StringRules = {
  ...
  fromJSON(object: any): StringRules {
    return {
      ...
      protobufFqn: isSet(object.protobufFqn) ? globalThis.Boolean(object.protobufFqn) : undefined,
      protobufDotFqn: isSet(object.protobufDotFqn) ? globalThis.Boolean(object.protobufDotFqn) : undefined,
