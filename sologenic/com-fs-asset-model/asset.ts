...
export const AssetDetails = {
  ...
  fromPartial<I extends Exact<DeepPartial<AssetDetails>, I>>(object: I): AssetDetails {
    ...
    message.DefaultHoldLimit = object.DefaultHoldLimit ?? "";
    return message;
  },
};
...
export const RealEstate = {
  ...
  fromJSON(object: any): RealEstate {
    return {
      ...
      KeyHighlights: globalThis.Array.isArray(object?.KeyHighlights)
        ? object.KeyHighlights.map((e: any) => globalThis.String(e))
        : [],
  ...
  toJSON(message: RealEstate): unknown {
    ...
    if (message.KeyHighlights?.length) {
  ...
  fromPartial<I extends Exact<DeepPartial<RealEstate>, I>>(object: I): RealEstate {
    ...
    message.Floors = object.Floors ?? undefined;
    message.HeightMeters = object.HeightMeters ?? undefined;
    message.Units = object.Units ?? undefined;
    message.AvailableUnits = object.AvailableUnits ?? undefined;
    message.ParkingSpaces = object.ParkingSpaces ?? undefined;
    message.Elevators = object.Elevators ?? undefined;
    message.Classification = object.Classification ?? undefined;
    message.YearRenovated = object.YearRenovated ?? undefined;
    message.LotSize = object.LotSize ?? undefined;
    message.ZoningType = object.ZoningType ?? undefined;
    message.CapRate = object.CapRate ?? undefined;
    message.NetOperatingIncome = object.NetOperatingIncome ?? undefined;
    message.KeyHighlights = object.KeyHighlights?.map((e) => e) || [];
    message.Amenities = object.Amenities?.map((e) => e) || [];
    message.PropertyDescription = object.PropertyDescription ?? "";
    return message;
  },
};
...
function createBaseDecCoinWithPrecision(): DecCoinWithPrecision {
  return { Denom: "", Amount: "", Precision: 0 };
}

export const DecCoinWithPrecision = {
  encode(message: DecCoinWithPrecision, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.Denom !== "") {
      writer.uint32(10).string(message.Denom);
    }
    if (message.Amount !== "") {
  ...
  create<I extends Exact<DeepPartial<DecCoinWithPrecision>, I>>(base?: I): DecCoinWithPrecision {
    return DecCoinWithPrecision.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<DecCoinWithPrecision>, I>>(object: I): DecCoinWithPrecision {
    const message = createBaseDecCoinWithPrecision();
    message.Denom = object.Denom ?? "";
    message.Amount = object.Amount ?? "";
...
export const TokenSale = {
  ...
  fromJSON(object: any): TokenSale {
    return {
      ...
      SellPricesPerSubunit: globalThis.Array.isArray(object?.SellPricesPerSubunit)
        ? object.SellPricesPerSubunit.map((e: any) => DecCoinWithPrecision.fromJSON(e))
        : [],
      ...
      BuyPricesPerSubunit: globalThis.Array.isArray(object?.BuyPricesPerSubunit)
        ? object.BuyPricesPerSubunit.map((e: any) => DecCoinWithPrecision.fromJSON(e))
        : [],
  ...
  fromPartial<I extends Exact<DeepPartial<TokenSale>, I>>(object: I): TokenSale {
    ...
    message.SellPricesPerSubunit = object.SellPricesPerSubunit?.map((e) => DecCoinWithPrecision.fromPartial(e)) || [];
    ...
    message.BuyPricesPerSubunit = object.BuyPricesPerSubunit?.map((e) => DecCoinWithPrecision.fromPartial(e)) || [];
...
function createBaseCrowdfund(): Crowdfund {
  return {
    QuantityStep: "",
    PricesPerSubunit: [],
    BaseDenom: "",
...
export const Crowdfund = {
  encode(message: Crowdfund, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.QuantityStep !== "") {
      writer.uint32(10).string(message.QuantityStep);
    }
  ...
  fromJSON(object: any): Crowdfund {
    return {
      ...
      PricesPerSubunit: globalThis.Array.isArray(object?.PricesPerSubunit)
        ? object.PricesPerSubunit.map((e: any) => DecCoinWithPrecision.fromJSON(e))
        : [],
      BaseDenom: isSet(object.BaseDenom) ? globalThis.String(object.BaseDenom) : "",
      MinAmount: isSet(object.MinAmount) ? globalThis.String(object.MinAmount) : "",
      StartDate: isSet(object.StartDate) ? globalThis.Number(object.StartDate) : 0,
  ...
  create<I extends Exact<DeepPartial<Crowdfund>, I>>(base?: I): Crowdfund {
    return Crowdfund.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<Crowdfund>, I>>(object: I): Crowdfund {
    const message = createBaseCrowdfund();
    message.QuantityStep = object.QuantityStep ?? "";
    message.PricesPerSubunit = object.PricesPerSubunit?.map((e) => DecCoinWithPrecision.fromPartial(e)) || [];
    message.BaseDenom = object.BaseDenom ?? "";
    message.MinAmount = object.MinAmount ?? "";
    message.StartDate = object.StartDate ?? 0;
    message.EndDate = object.EndDate ?? 0;
    message.MinThreshold = object.MinThreshold ?? "";
    message.MaxThreshold = object.MaxThreshold ?? "";
